...
String ENVDT_PROD_ID;
	...
	Integer 	ENVDT_IDP;
	@ApiModelProperty(value = "ENVDT_SUBTOTAL", required = true, dataType = "double", example = "00000000", position = 7)
	 double ENVDT_SUBTOTAL;
		@ApiModelProperty(value = "ENVDT_IVA", required = true, dataType = "double", example = "00000000", position = 8)
	 double ENVDT_IVA;
		@ApiModelProperty(value = "ENVDT_DESCUENTO", required = true, dataType = "double", example = "00000000", position = 9)
	 double ENVDT_DESCUENTO;
...
public DetalleEnvioTemp(String eNVDT_PROD_ID, String eNVDT_CANTIDAD, String eNVDT_PRECIO, String eNVDT_TOTAL,
		String eNVDT_ID, Integer eNVDT_IDP, double eNVDT_SUBTOTAL, double eNVDT_IVA, double eNVDT_DESCUENTO) {
	super();
	...
	ENVDT_ID = eNVDT_ID;
	ENVDT_IDP = eNVDT_IDP;
	ENVDT_SUBTOTAL = eNVDT_SUBTOTAL;
	ENVDT_IVA = eNVDT_IVA;
	ENVDT_DESCUENTO = eNVDT_DESCUENTO;
}
...
public double getENVDT_SUBTOTAL() {
	return ENVDT_SUBTOTAL;
}

public void setENVDT_SUBTOTAL(double eNVDT_SUBTOTAL) {
	ENVDT_SUBTOTAL = eNVDT_SUBTOTAL;
}

public double getENVDT_IVA() {
	return ENVDT_IVA;
}

public void setENVDT_IVA(double eNVDT_IVA) {
	ENVDT_IVA = eNVDT_IVA;
}

public double getENVDT_DESCUENTO() {
	return ENVDT_DESCUENTO;
}

public void setENVDT_DESCUENTO(double eNVDT_DESCUENTO) {
	ENVDT_DESCUENTO = eNVDT_DESCUENTO;
}
...
public String toString() {
	return "DetalleEnvioTemp [ENVDT_PROD_ID=" + ENVDT_PROD_ID + ", ENVDT_CANTIDAD=" + ENVDT_CANTIDAD + ", ENVDT_PRECIO="
			...
			+ ", ENVDT_SUBTOTAL=" + ENVDT_SUBTOTAL + ", ENVDT_IVA=" + ENVDT_IVA + ", ENVDT_DESCUENTO=" + ENVDT_DESCUENTO
			+ "]";
}
