CREATE
OR REPLACE PROCEDURE  SCH_CN.GL_PListarUsuarios(OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarUsuarios (
	  p_USU_NOMBRES_init,
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarUsuarios (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarUsuarios (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarUsuariosNombre (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarUsuariosId (
 p_codigo_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PValidarUsuario (
  ...
  --
	...
	OPEN OUT_CURSOR FOR
     ...
     FROM
       SCH_CN.GL_TUSUARIOS
	   WHERE
         USU_CORREO = p_usuario_init AND USU_PASSWORD = p_password_init;
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PCambiarContrasena (
	  p_USU_CORREO_init IN VARCHAR2,
	  p_USU_PASSWORD_init IN VARCHAR2	  
) AS BEGIN
 --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PMostrarPerfil (
	  p_USU_CORREO_init IN VARCHAR2,
	  p_USU_PASSWORD_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR	  
) AS BEGIN
