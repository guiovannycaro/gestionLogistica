CREATE
OR REPLACE PROCEDURE  SCH_CN.GL_PListarProductos(OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarProductos (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarProductos (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarProductos (
 p_codigo_init IN VARCHAR2
) AS BEGIN
--
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarProductosNombre (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarProductosId (
 p_codigo_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR
