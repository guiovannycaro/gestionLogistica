CREATE
OR REPLACE PROCEDURE  SCH_CN.GL_PListarDetalleEnvioTemp(OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarDetalleEnvioTemp (
    p_ENVDT_PROD_ID_init IN NUMBER,
    p_ENVDT_CANTIDAD_init IN NUMBER,
    p_ENVDT_PRECIO_init IN NUMBER,
	p_ENVDT_SUBTOTAL_init IN NUMBER,
	p_ENVDT_IVA_init IN NUMBER,
    p_ENVDT_DESCUENTO_init IN NUMBER,
...
p_ENVDT_TOTAL_init,
p_DATENV_REF_init,
p_ENVDT_SUBTOTAL_init,
p_ENVDT_IVA_init,
p_ENVDT_DESCUENTO_init );
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarDetalleEnvioTemp (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarDetalleEnvioTemp (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarDetalleEnvioTempProducto (
