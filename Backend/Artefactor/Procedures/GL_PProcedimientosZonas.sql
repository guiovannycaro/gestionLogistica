CREATE
OR REPLACE PROCEDURE  SCH_CN.GL_PListarZonas(OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarZonas (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarZonas (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarZonas (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarZonasNombre (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarZonasId (
 p_codigo_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR
