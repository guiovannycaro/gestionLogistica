CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PListarClientes (OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarCliente (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarCliente (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarCliente (
 p_codigo_init IN VARCHAR2
) AS BEGIN
--
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarClienteNombre (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarClienteId (
 p_codigo_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR
