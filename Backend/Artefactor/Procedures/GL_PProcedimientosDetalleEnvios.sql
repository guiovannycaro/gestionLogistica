CREATE
OR REPLACE PROCEDURE  SCH_CN.GL_PListarDetalleEnvio(OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarDetalleEnvio (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarDetalleEnvioTempD (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarDetalleEnvio (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarDetalleEnvio (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarDetalleEnvioProducto (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarDetalleEnvioId (
 p_codigo_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR
