CREATE
OR REPLACE PROCEDURE  SCH_CN.GL_PListarTipoBodega(OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarTipoBodega (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarTipoBodega (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarTipoBodega (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarTipoBodegaNombre (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarTipoBodegaId (
 p_codigo_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR
