CREATE
OR REPLACE PROCEDURE  SCH_CN.GL_PListarRoles(OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarRol (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarRol (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarRol (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarRolesNombre (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarRolesId (
 p_codigo_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR
