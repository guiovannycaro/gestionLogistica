CREATE
OR REPLACE PROCEDURE  SCH_CN.GL_PListarEnvio(OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarEnvio (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarEnvio (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarEnvio (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarEnvioDetallTem (
 p_codigo_init IN VARCHAR2
) AS BEGIN
--
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarEnvioCliente (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarEnvioId (
 p_codigo_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR
