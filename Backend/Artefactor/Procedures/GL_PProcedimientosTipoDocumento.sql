CREATE
OR REPLACE PROCEDURE  SCH_CN.GL_PListarTipoDocumento(OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarTipoDocumento (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarTipoDocumento (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarTipoDocumento (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarTipoDocumentoNombre (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarTipoDocumentoId (
 p_codigo_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR
