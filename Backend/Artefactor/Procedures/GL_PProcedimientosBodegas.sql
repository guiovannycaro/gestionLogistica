CREATE
OR REPLACE PROCEDURE  SCH_CN.GL_PListarBodega(OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarBodega (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarBodega (
 p_codigo_init IN VARCHAR2
) AS BEGIN
--
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarBodegaNombre (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarBodegaId (
 p_codigo_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR
