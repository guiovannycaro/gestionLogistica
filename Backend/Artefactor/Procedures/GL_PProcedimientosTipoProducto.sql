CREATE
OR REPLACE PROCEDURE  SCH_CN.GL_PListarTipoProducto(OUT_CURSOR OUT SYS_REFCURSOR) AS BEGIN
--
  --
  --
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PInsertarTipoProducto (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEditarTipoProducto (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PEliminarTipoProducto (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarTipoProductoNombre (
...
CREATE
OR REPLACE PROCEDURE SCH_CN.GL_PBuscarTipoProductoId (
 p_codigo_init IN VARCHAR2,
OUT_CURSOR OUT SYS_REFCURSOR
